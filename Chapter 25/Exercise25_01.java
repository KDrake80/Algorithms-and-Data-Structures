 ...
 * Kevin Drake
 * 3/1/22
 * Wrote the code for the Recursive height methods, and the code for the breadthFirstTraversal method
 * The height method returns the int height count of the tree invoking the method. The breadth first traversal displays the
 * trees level by level, Starting with root then getting next level, and so on.
 */
public class Exercise25_01 {
	...
	public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
		 ...
		 */
		/* For this method, we will 2 height methods. One has no parameters and will default to using root to determine the height. The second+
		 *  has a TreeNode node parameter and will find the height
		 *  of the BST from that respective node. The second method will use recursion.
		 * 1. For the no parameter height method, we call the parameter height method with root as an argument.
		 * 2. The parameter height method accepts root as a parameter. If root does not have a value, return 0 for height.
		 * 3. Otherwise, compare the height of the left child node to the height of the right child node. To find these heights you will
		 *  need to recursively call the method.
		 */
		public int height() {
		...
		public void breadthFirstTraversal() {
			...
			java.util.ArrayList<TreeNode<E>> nodeList = new java.util.ArrayList<>();
			...
			if (root == null) return;
				...
				while (nodeList.size() > 0) {
					TreeNode<E> current = nodeList.get(0);
		...
		public java.util.ArrayList<TreeNode<E>> path(E e) {
			java.util.ArrayList<TreeNode<E>> list = new 
