 ...
 * Kevin Drake
 * 3/1/22
 * This program prompts the user to enter ten numbers, then displays their Inorder traversal of the tree.
 * The method is writeen without recursion. It is the method all the way at bottom
 */
	...
	public static class BST<E extends Comparable<E>> extends AbstractTree<E> {
		...
		public void nonRecursiveInorder() {
			...
			if (root == null) {
				...
				E parent = root.element;
				E current = root.left.element;
				for (E e : BST.this) {
					if (e.compareTo(current) >= 0) {
						this.delete(current);
						current = e;
					}
					stack.push(createNewNode(current));
					
				}
				for(int i = 0; i < stack.size(); i++) {
					TreeNode<E> focus = stack.get(i);
					System.out.println(focus.element);
				}
			}
		}
	}
