 ...
 * Kevin Drake
 * 2/9/22
 * This Program I rewrote to display the questions randomly from the list
 */
import java.util.*;
...
public class Exercise08_37 {
  public static void main(String[] args) {
    ...
    List<String[]> states = Arrays.asList(stateCapital);
    Collections.shuffle(states, new Random(10));
    int correctCount = 0;
